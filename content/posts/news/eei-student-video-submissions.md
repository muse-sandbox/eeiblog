...
wp_id: 208
wp_type: post
slug: eei-student-video-submissions-draft
status: draft
...
excerpt: |
  Students and teachers can make audio or video recordings through EEi — with submissions sent to the teacher for feedback on posture, hand position, embouchure, and more.
seo:
...
notes: |
  ...
  This was a "Coming this Fall" announcement; in 2026 video submissions are live. Editorial pass should rewrite this as a feature page.
  Open follow-ups: rename slug; replace embedded sign-up form when feedback page form is ready.
---

(see WP post id 208 for body)
