...
wp_id: 213
wp_type: post
slug: ee-band-talk-subscribe-draft
status: draft
...
excerpt: |
  Subscribe to EE Band Talk — receive e-mail updates when new episodes are available.
seo:
...
notes: |
  ...
  KNOWN GAP: subscribe form did not migrate. Need to add a Constant Contact / Mailchimp / Jetpack Subscriptions form.
  Open follow-ups: rename slug; add subscribe form.
---

(see WP post id 213 for body)
